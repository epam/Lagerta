...
package org.apache.ignite.activestore.config;
...
import org.apache.ignite.activestore.impl.InMemoryKeyValueProvider;
...
/**
 * Configuration class which allows user to wire all classes for in-memory-based store.
 */
public class InMemoryActiveStoreConfiguration extends BaseActiveStoreConfiguration {
    /** {@inheritDoc} */
    @Override public void afterPropertiesSet() throws Exception {
        ...
        bindings.put(KeyValueProvider.class, InMemoryKeyValueProvider.class);
