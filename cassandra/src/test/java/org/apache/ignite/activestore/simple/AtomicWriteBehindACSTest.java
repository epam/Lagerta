...
/**
 * Base test for caches with atomic caches and write behind.
 */
public abstract class AtomicWriteBehindACSTest extends WriteBehindACSTest {
    /** */
    @Test
    public void testRollbackTransaction() throws InterruptedException {
        ...
        Assert.assertEquals("57", readKV("c", firstCache, oldHead));
        Assert.assertEquals("8", readKV("d", firstCache, oldHead));
    }
}
