...
package org.apache.ignite.activestore.impl.cassandra.session.pool;
        ...
        @Override public void run() {
            try {
                while (true) {
                    ...
                    // all sessions in the pool expired, thus we don't need additional thread to manage sessions in
                    // the pool
