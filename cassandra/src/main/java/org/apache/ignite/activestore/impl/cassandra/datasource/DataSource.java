...
package org.apache.ignite.activestore.impl.cassandra.datasource;
...
import org.apache.ignite.activestore.impl.cassandra.session.CassandraSessionImpl;
...
public class DataSource implements Externalizable {
    ...
    /**
     * Null object, used as a replacement for those Cassandra connection options which don't support serialization
     * (RetryPolicy, LoadBalancingPolicy and etc).
     */
