...
public class AtomicsHelper {
    ...
    private static class CacheReference<V> implements Reference<V> {

        private final IgniteCache<Object, Object> cache;
        private final String name;

        public CacheReference(IgniteCache<Object, Object> cache, String name) {
            this.cache = cache;
            this.name = name;
        }
        ...
        /** {@inheritDoc} */
        @Override public V initIfAbsent(V value) {
            if (cache != null) {
