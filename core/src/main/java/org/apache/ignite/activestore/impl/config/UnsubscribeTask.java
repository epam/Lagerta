...
public class UnsubscribeTask implements Runnable {
    ...
    public UnsubscribeTask(ReplicaProducersManagerUpdater producersManagerUpdater, UUID clusterId, Exception e) {
    ...
    @Override public void run() {
        producersManagerUpdater.unsubscribe(clusterId, e);
    }
}
