 ...
 * ActiveCacheStore}.
 */
public abstract class BaseActiveStoreConfiguration implements BeanFactoryPostProcessor, BeanNameAware, InitializingBean,
    Serializable {
    ...
    private static final Factory ACTIVE_CACHE_STORE_FACTORY = new Factory<ActiveCacheStore>() {
        ...
        @Inject
        private transient ActiveCacheStore activeCacheStore;

        /** {@inheritDoc} */
        @Override public ActiveCacheStore create() {
            // TODO 125 is it possible to get rid of ignite here?
