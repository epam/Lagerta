...
class TxInfo {
    ...
    private final TransactionMetadata txMetadata;

    public TxInfo(UUID consumerId, TransactionMetadata txMetadata) {
    ...
    public TransactionScopeIterator scopeIterator() {
        return txMetadata.scopeIterator();
    }
    ...
    public String toString() {
        return "TxInfo{" + f(consumerId) + ", " + txMetadata + '}';
    }
}
