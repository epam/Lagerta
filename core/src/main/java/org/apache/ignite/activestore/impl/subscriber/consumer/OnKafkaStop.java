 ...
 * @since 2/6/2017 12:25 AM
 */
@Singleton
class OnKafkaStop implements Runnable {
    private final LeadService lead;
    private final UUID consumerId;

    @Inject
    public OnKafkaStop(LeadService lead, @Named(DataCapturerBusConfiguration.NODE_ID) UUID consumerId) {
        this.lead = lead;
